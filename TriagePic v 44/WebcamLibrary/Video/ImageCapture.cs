...
namespace DevEck.Devices.Video
{
    ...
    public class ImageCapture : ISampleGrabberCB, IDisposable
    {
        ...
        //        ArraySubType = UnmanagedType.IUnknown)] object lplpUnk,
        //    [MarshalAs(UnmanagedType.U4)] int cPages,
        //    [MarshalAs(UnmanagedType.LPArray,
        //        ArraySubType = UnmanagedType.Struct)] IntPtr lpPageClsID,
        //    int lcid,
        ...
        public void DisplayPropertyPage()
        {
            ...
            _device.DsDevice.Mon.BindToObject(null, null, ref iid, out source);

            IBaseFilter dev = source as IBaseFilter;
            ...
            hr = OleCreatePropertyFrame(IntPtr.Zero, 0, 0, filterInfo.achName, 1, ref oDevice, caGUID.cElems, caGUID.pElems, 0, 0, IntPtr.Zero);
            DsError.ThrowExceptionForHR(hr);

            // Release COM objects
            Marshal.FreeCoTaskMem(caGUID.pElems);
            Marshal.ReleaseComObject(pProp);
            if (filterInfo.pGraph != null) Marshal.ReleaseComObject(filterInfo.pGraph);
        }
    }
}
